...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 06-12-2024 a las 20:59:48
...
('102030', 'Mopas', 2, 5, 10, 5, 'O'),
('A1010', 'GAS ', 1, 10, 5, 2, 'A'),
('B01', 'JABÓN', 0, 10.5, 5, 2, 'A'),
('B02', 'GAS DE AIRE', 0, 15.9, 5, 1, 'O'),
('b03', 'Cepillo', 0, 3.5, 1, 1, 'O'),
('htfghdgbc', 'aaa', 2, 1, 1, 1, 'O'),
('R1020', 'COLETO', 3, 3, 1, 1, 'A');
...
(3, 'Lluvia', 'Estaba lloviendo y no tuvo posibilidades de llegar', 'A');
...
(4, 'aa', 'a', '123', 1, 'a', 'A'),
(5, 'Mary', 'Mary Perez', '1234', 1, '1001.30334762.ucla@gmail.com', 'A');
